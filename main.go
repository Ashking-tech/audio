...
import (
	...
	"github.com/Ashking-tech/audio/recorder"
	"github.com/Ashking-tech/audio/webapp"
)
...
func main() {
	...
	case "listen":
		...
		samples, err := recorder.Record(duration, 44100)
		if err != nil {
			log.Fatal(err)
		}
	...
	case "serve":
		srv := webapp.NewServer(database, ":8082")
		log.Fatal(srv.Start())
